...
public class PRQuadTreeTest extends student.TestCase {
    ...
    public void testRemovebyCoor3() {
        ...
        assertFuzzyEquals("point removed C 1000 1000",
                systemOut().getHistory());
        systemOut().clearHistory();
        c.removebyCoor(1001, 1001);
        assertFuzzyEquals("point not found 1001 1001",
                systemOut().getHistory());
    ...
    public void testRegionSearch1() {
        ...
        assertFuzzyEquals(
                ...
                systemOut().getHistory());
        systemOut().clearHistory();
        c.regionSearch(724, 724, 300, 300);
        assertFuzzyEquals(
                "Points intersecting region (724, 724, 300, 300):\nPoint "
                        + "found: (I, 1023, 1023)\n2 quadtree nodes visited",
                systemOut().getHistory());
        systemOut().clearHistory();
        c.regionSearch(700, 0, 300, 300);
        assertFuzzyEquals(
                "Points intersecting region (700, 0, 300, "
                        + "300):\nPoint found: (G, 900, 20)\nPoint found: "
                        + "(H, 800, 20)\n2 quadtree nodes visited",
                systemOut().getHistory());
        systemOut().clearHistory();
        c.regionSearch(0, 700, 300, 300);
        assertFuzzyEquals(
